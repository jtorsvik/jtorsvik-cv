...
export const es: Locale = {
  ...
  experiences: [
    // 0 – Sopra Steria
    {
      role: 'Manager Consultor en Ciencia de Datos',
      engagements: [
        // 0 – SVV Saga
        {
