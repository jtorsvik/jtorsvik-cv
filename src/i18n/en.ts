...
export const en: Locale = {
  ...
  ui: {
    ...
    langNative:           'Norwegian (native)',
    langFluent:           'English (fluent)',
    langB2:               'Spanish (B2)',
  },
  ...
  summary: [
    'Joakim Martin Torsvik is an experienced Senior Full-Stack Data Scientist with many years of experience in data and analytics across various sectors. With a Master\'s degree in Data Science and a Bachelor\'s degree in Finance, he has worked for major organisations including Equinor, Bane NOR, Statens Vegvesen and Aon, solving complex analytical and machine learning challenges while contributing to the development of large-scale data platforms capable of addressing demanding business needs.',
  ...
  experiences: [
    // 0 – Sopra Steria
    {
      ...
      engagements: [
        ...
        {
          title: 'Senior Data Platform Developer / Platform Architect',
          bullets: [
